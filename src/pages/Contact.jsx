  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'santoshkumar321b@gmail.com',
      link: 'mailto:santoshkumar321b@gmail.com'
    },
    {
      icon: (
      ...
      label: 'LinkedIn',
      value: 'linkedin.com/in/bommepalli-santosh-kumar-reddy',
      link: 'https://linkedin.com/in/bommepalli-santosh-kumar-reddy'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: 'GitHub',
      value: 'github.com/santosh-kumar-git',
      link: 'https://github.com/santosh-kumar-git'
    }
  ]
